...
console.error(JSON.stringify({ runner: 'madeproof-local', version: '0.1.0', capabilities: ['command', 'network-disabled-linux-namespace', 'resource-limits', 'ephemeral-copy'] }));
